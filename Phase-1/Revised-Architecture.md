...
| Employee accounts | Employees may use ordinary free personal Gmail/Google Accounts. No employee-by-employee Google Not required for employees; ordinary Gmail/Google Accounts can be used is required for the target implementation. |
...
| Build principle | Prefer native Google services and the simplest maintainable workflow. Do not introduce Google-native services (Sites, Sheets, Forms, Drive, Apps Script) billing, Not required, paid databases, Not required; use Apps Script email services within quotas APIs, Not required or Not required for employees; ordinary Gmail/Google Accounts can be useds unless a future requirement explicitly proves them necessary. |
|  |  |
